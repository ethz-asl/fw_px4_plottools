...
function setupTopics()
    ...
    topics.battery_status = ...
        ...
        "remaining" , "scale", "cell_count", "connected", "warning"]);
    ...
    topics.differential_pressure = ...
        ...
        "differential_pressure_filtered", "temperature"]);
    ...
    topics.sensor_preflight = ...
        ...
        'fields', ["acc_inconsistency", "gyro_inconsistency"]);
    topics.system_power = ...
        struct('topic_name', 'system_power', 'logged', false,...
        'fields', ["voltage5V", "usb_connected", "brick_valid",...
        "servo_valid", "periph_5V_OC", "hipower_5V_OC"]);
    ...
    topics.tecs_status = ...
        ...
        "flightPathAngle", "flightPathAngleFiltered", "airspeedSp", "airspeed_filtered",...
    ...
    topics.vehicle_command = ...
        ...
        "source_system", "source_component", "confirmation"]);
    topics.vehicle_global_position = ...
        struct('topic_name', 'vehicle_global_position', 'logged', false,...
        'fields', ["time_utc", "lat", "lon", "delta_lat_lon_0",...
        "delta_lat_lon_1", "alt", "delta_alt", "vel_n", "vel_e", "vel_d",...
        "pos_d_deriv", "yaw", "eph", "epv", "evh", "evv", "terrain_alt",...
        "pressure_alt", "lat_lon_reset_counter", "alt_reset_counter",...
    ...
    topics.vehicle_local_position = ...
        ...
        "surface_bottom_timestamp", "x", "y", "z", "delta_xy_0",...
        ...
        "estimator_type", "xy_valid", "z_valid", "v_xy_valid", "v_z_valid",...
