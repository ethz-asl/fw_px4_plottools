function [airspeed_true, airspeed_indicated] = CalculateAirspeed(dp_data, baro_data, temp_data, config)
...
airspeed_indicated = (sqrt(2.0*abs(dp_corr) / 1.225) + dv) * config.airspeed_scale_factor;
