...
params.cal_av_aoa_id = ...
    struct('param_name', 'cal_av_aoa_id', 'logged', false);
params.cal_av_slip_id = ...
    struct('param_name', 'cal_av_slip_id', 'logged', false);
params.cal_av_aoa_off = ...
    struct('param_name', 'cal_av_aoa_off', 'logged', false);
params.cal_av_slip_off = ...
    struct('param_name', 'cal_av_slip_off', 'logged', false);
params.cal_av_aoa_max = ...
    struct('param_name', 'cal_av_aoa_max', 'logged', false);
params.cal_av_aoa_min = ...
    struct('param_name', 'cal_av_aoa_min', 'logged', false);
params.cal_av_aoa_rev = ...
    struct('param_name', 'cal_av_aoa_rev', 'logged', false);
params.cal_av_aoa_p0 = ...
    struct('param_name', 'cal_av_aoa_p0', 'logged', false);
params.cal_av_aoa_p1 = ...
    struct('param_name', 'cal_av_aoa_p1', 'logged', false);
params.cal_av_aoa_p2 = ...
    struct('param_name', 'cal_av_aoa_p2', 'logged', false);
params.cal_av_aoa_p3 = ...
    struct('param_name', 'cal_av_aoa_p3', 'logged', false);
params.cal_av_slip_min = ...
    struct('param_name', 'cal_av_slip_min', 'logged', false);
params.cal_av_slip_max = ...
    struct('param_name', 'cal_av_slip_max', 'logged', false);
params.cal_av_slip_rev = ...
    struct('param_name', 'cal_av_slip_rev', 'logged', false);
params.cal_av_slip_p0 = ...
    struct('param_name', 'cal_av_slip_p0', 'logged', false);
params.cal_av_slip_p1 = ...
    struct('param_name', 'cal_av_slip_p1', 'logged', false);
params.cal_av_slip_p2 = ...
    struct('param_name', 'cal_av_slip_p2', 'logged', false);
params.cal_av_slip_p3 = ...
    struct('param_name', 'cal_av_slip_p3', 'logged', false);

% legacy airflow vane calibration parameters
params.cal_aoa_off = ...
...
params.cal_air_scale = ...
    struct('param_name', 'cal_air_scale', 'logged', false);
